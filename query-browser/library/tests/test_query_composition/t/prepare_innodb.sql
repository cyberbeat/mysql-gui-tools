...
CREATE TABLE `таблица2` (
  `поле1` VARCHAR (50) collate utf8_bin, primary key (`поле1`)
...
CREATE TABLE `таблица1` (  
  ...
  index(`поле1`),
  FOREIGN KEY (`поле1`) REFERENCES t4(`поле1`)
) DEFAULT CHARACTER SET utf8 COLLATE=utf8_bin;

INSERT INTO `таблица1` VALUES 
('значение3','значение1_3'),
('значение4','значение1_4'),
('значение5','значение1_5');
