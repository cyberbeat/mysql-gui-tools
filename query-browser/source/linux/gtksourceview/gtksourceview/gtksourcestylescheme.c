...
gtk_source_default_style_scheme_init (GtkSourceDefaultStyleScheme *scheme)
{
	...
	ts = new_tag_style ("#ff8888", NULL, FALSE, FALSE);
	...
	ts = new_tag_style ("#008282", NULL, FALSE, TRUE);
	g_hash_table_insert (scheme->styles, 
			     g_strdup (N_("Comment")),
			     ts);

	ts = new_tag_style ("#000000", NULL, FALSE, FALSE);
	g_hash_table_insert (scheme->styles, 
			     g_strdup (N_("Data Type")),
			     ts);

	ts = new_tag_style ("#000000", NULL, TRUE, FALSE);
	g_hash_table_insert (scheme->styles, 
	...
	ts = new_tag_style ("#008000", NULL, FALSE, FALSE);
	g_hash_table_insert (scheme->styles, 
			     g_strdup (N_("String")),
			     ts);

	ts = new_tag_style ("#FF00FF", "#FF0000", FALSE, FALSE);
	g_hash_table_insert (scheme->styles, 
