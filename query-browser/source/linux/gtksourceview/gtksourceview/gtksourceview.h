...
void 		 gtk_source_view_set_compose_line_markers  (GtkSourceView   *view,
                                                            gboolean         compose);
gboolean	 gtk_source_view_get_compose_line_markers  (GtkSourceView   *view);
...
void             gtk_source_view_set_marker_highlight_colors 
							(GtkSourceView   *view,
							 const gchar     *marker_type,
							 GdkColor        *fg_color,
                                                         GdkColor	 *bg_color);

gboolean	 gtk_source_view_get_marker_highlight_colors
							(GtkSourceView   *view,
				       			 const gchar     *marker_type,
							 GdkColor	 *fg_color,
							 GdkColor	 *bg_color);
