...
set MERGE_CUB=%ProgramFiles%\MsiVal2\mergemod.cub
set ALL_CUB=%ProgramFiles%\MsiVal2\darice.cub

rem The following variables normally do not need to be
rem changed.
set MSM_GPL=..\bin\dist\mysql_query_browser_gpl.msm
set MSM_COM=..\bin\dist\mysql_query_browser_commercial.msm
set MSI_GPL=..\bin\dist\mysql_query_browser_gpl.msi
set MSI_COM=..\bin\dist\mysql_query_browser_commercial.msi
