unit MyxTableEditorFkColumnVTEdit;
...
type
  TForeignKeyColumnGridEditLink = class;

  TForeignKeyColumnGridEdit = class(TTntCustomComboBox)
  private
    FRefLink: IVTEditLink;
    FLink: TForeignKeyColumnGridEditLink;
    FModified: Boolean;
  ...
  public
    constructor Create(Link: TForeignKeyColumnGridEditLink); reintroduce;
  ...
  TForeignKeyColumnGridEditLink = class(TInterfacedObject, IVTEditLink)
  private
    FEdit: TForeignKeyColumnGridEdit;
    ...
    procedure SetEdit(const Value: TForeignKeyColumnGridEdit);
  protected
    function GetGrt: TGrt;
  public
    FColumnList: Pointer;
    ...
    property Edit: TForeignKeyColumnGridEdit read FEdit write SetEdit;
...
//----------------- TForeignKeyColumnGridEdit --------------------------------------------------------------------------------------------

// Implementation of a generic node caption editor.

constructor TForeignKeyColumnGridEdit.Create(Link: TForeignKeyColumnGridEditLink);
...
function TForeignKeyColumnGridEdit.GetGrt: TGrt;
...
procedure TForeignKeyColumnGridEdit.CMAutoAdjust(var Message: TMessage);
...
procedure TForeignKeyColumnGridEdit.CMExit(var Message: TMessage);
...
procedure TForeignKeyColumnGridEdit.CMRelease(var Message: TMessage);
...
procedure TForeignKeyColumnGridEdit.CNCommand(var Message: TWMCommand);
...
procedure TForeignKeyColumnGridEdit.WMChar(var Message: TWMChar);
...
procedure TForeignKeyColumnGridEdit.WMDestroy(var Message: TWMDestroy);
...
procedure TForeignKeyColumnGridEdit.WMGetDlgCode(var Message: TWMGetDlgCode);
...
procedure TForeignKeyColumnGridEdit.KeyDown(var Key: Word; Shift: TShiftState);
...
procedure TForeignKeyColumnGridEdit.KeyUp(var Key: Word; Shift: TShiftState);
...
procedure TForeignKeyColumnGridEdit.AutoAdjustSize;
...
procedure TForeignKeyColumnGridEdit.CreateParams(var Params: TCreateParams);
...
procedure TForeignKeyColumnGridEdit.Release;
...
//----------------- TForeignKeyColumnGridEditLink ------------------------------------------------------------------------------------

constructor TForeignKeyColumnGridEditLink.Create(ColumnList: Pointer;
  InitialText: WideString);

begin
  inherited Create;
  FEdit := TForeignKeyColumnGridEdit.Create(Self);
  with FEdit do
  begin
    Visible := False;
...
destructor TForeignKeyColumnGridEditLink.Destroy;
...
function TForeignKeyColumnGridEditLink.GetGrt: TGrt;
...
function TForeignKeyColumnGridEditLink.BeginEdit: Boolean;
...
procedure TForeignKeyColumnGridEditLink.SetEdit(const Value: TForeignKeyColumnGridEdit);
...
function TForeignKeyColumnGridEditLink.CancelEdit: Boolean;
...
function TForeignKeyColumnGridEditLink.EndEdit: Boolean;
...
function TForeignKeyColumnGridEditLink.GetBounds: TRect;
...
function TForeignKeyColumnGridEditLink.PrepareEdit(Tree: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex): Boolean;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        FEdit.Items.Add(Grt.DictString[
          Grt.ListItem[FColumnList, I], 'name']);
      end;

      FEdit.Perform(CB_SETDROPPEDWIDTH, 250, 0);
    end;
...
procedure TForeignKeyColumnGridEditLink.ProcessMessage(var Message: TMessage);
...
procedure TForeignKeyColumnGridEditLink.SetBounds(R: TRect);
