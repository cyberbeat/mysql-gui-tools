...
uses
  ...
  EXTCtrls, OleCtrls, Mshtml{_tlb}, SHDocVw{_tlb}, ActiveX, shlObj, Wininet, Urlmon, shellapi; //MikeZ: include new uses
...
{$ENDIF}
  GetDDEVariables;
  DDEHWnd := Classes.AllocateHWnd(DDEWndProc); //MikeZ: fixed warning
...
begin
  Classes.DeAllocateHWnd(DDEHwnd); //MikeZ: fixed warning
