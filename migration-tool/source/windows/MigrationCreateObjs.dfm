object MigrationCreateObjsForm: TMigrationCreateObjsForm
  Left = 271
  Top = 174
  ...
  object DockPnl: TTntPanel
    ...
    object MainPngControl: TTntPageControl
      ...
      Width = 765
      Height = 534
      ActivePage = CreateOptionsTabSheet
      Align = alClient
      Style = tsFlatButtons
      TabOrder = 0
      object CreateOptionsTabSheet: TTntTabSheet
        Caption = 'CreateOptions'
        object TntGroupBox2: TTntGroupBox
          Left = 16
          Top = 10
          Width = 725
          Height = 225
          Caption = 'Object Creation Options'
          TabOrder = 0
          object TntLabel1: TTntLabel
            ...
            Width = 214
            Height = 13
            Caption = 'Database Object Creation Parameters'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
          ...
          object TntLabel3: TTntLabel
            ...
            AutoSize = False
            Caption = 
              'Select the desired options for the object creation. Click Next >' +
          ...
          object TntLabel6: TTntLabel
            ...
            AutoSize = False
            Caption = 
              'Select this option to create the objects on the target database.' +
              ' If there is a problem during the creation process you will be i' +
              'nformed and can fix the used statement by pressing the [Details ' +
              '>>] button.'
            WordWrap = True
          end
          object ScriptFileNameLbl: TTntLabel
            Left = 48
            Top = 184
            Width = 45
            Height = 13
          ...
          object TntLabel5: TTntLabel
            ...
            AutoSize = False
            Caption = 
              'If you want to store the object creation in a script file enable' +
              ' this option. You can use this option in parallel to creating th' +
              'e objects online option if you want to have a backup of the SQL ' +
              'commands.'
            WordWrap = True
          end
          object CreateObjectsCBox: TTntCheckBox
            Left = 30
            Top = 98
            Width = 309
            Height = 17
            Caption = 'Create Objects Online'
            Checked = True
            State = cbChecked
            TabOrder = 0
          end
          object CreateScriptCBox: TTntCheckBox
            Left = 32
            Top = 158
            Width = 309
            Height = 17
            Caption = 'Create Script File for Create Statements'
            TabOrder = 1
            OnClick = CreateScriptCBoxClick
          end
          object ScriptFileNameEd: TTntEdit
            Left = 102
            Top = 180
            Width = 201
            Height = 21
            Enabled = False
            TabOrder = 2
            Text = 'C:\CreateStatements.sql'
          end
          object ChooseCreatesFileBtn: TTntButton
            Left = 306
            Top = 180
            Width = 27
            Height = 21
            ...
            Enabled = False
            TabOrder = 3
            OnClick = ChooseCreatesFileBtnClick
          end
        end
      end
      object CreateObjTabSheet: TTntTabSheet
        Caption = 'CreateObjs'
        ExplicitLeft = 0
        ExplicitTop = 0
        ExplicitWidth = 0
        ...
        object TntGroupBox6: TTntGroupBox
          ...
          Width = 725
          Height = 227
          Caption = 'Create Schema Objects'
          TabOrder = 0
          object CreateImg: TTntImage
            Left = 68
            Top = 126
            Width = 13
            Height = 14
          ...
          object TntLabel11: TTntLabel
            ...
            Width = 172
            Height = 13
            Caption = 'Create/Write Schemata and Objects'
          end
          ...
          object ConnectLbl: TTntLabel
            Left = 88
            Top = 100
            Width = 135
            Height = 13
            Caption = 'Connect to Target Database'
          end
      ...
      object CreateResultsTabSheet: TTntTabSheet
        Caption = 'CreateResults'
        ExplicitLeft = 0
        ExplicitTop = 0
        ExplicitWidth = 0
        ExplicitHeight = 0
        object LogOptionPnl: TTntPanel
          ...
          object LogOptionsGBox: TTntGroupBox
            ...
            object TntLabel7: TTntLabel
              ...
              Anchors = [akRight, akBottom]
              AutoSize = False
              Caption = 'Recreate the objects after SQL state- ments have been changed.'
              WordWrap = True
            end
            ...
            object RecreateObjectsBtn: TTntButton
              Left = 618
              Top = 202
              Width = 99
              Height = 25
              ...
              TabOrder = 3
              OnClick = RecreateObjectsBtnClick
            end
        ...
        object LogMainPnl: TTntPanel
          ...
          object LogFilterComboBox: TTntComboBox
            ...
            ItemIndex = 0
            TabOrder = 1
            Text = 'Show Create Problems'
            OnCloseUp = LogFilterComboBoxCloseUp
            Items.Strings = (
              'Show Create Problems'
              'Show All Objects'
          ...
          object NoMapProblemsPnl: TTntPanel
            ...
            object TntLabel2: TTntLabel
              ...
              Width = 161
              Height = 13
              Caption = 'No creation problems found.'
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clWindowText
              Font.Height = -11
              Font.Name = 'MS Sans Serif'
            ...
            object TntLabel4: TTntLabel
              ...
              Width = 203
              Height = 13
              Caption = 'Use the Filter to browse all created objects.'
            end
